...
| --- | --- | --- |
| `memory-evidence` | Internal Git-backed memory practices | Git-first layers, source provenance, bounded retrieval, read-back validation |
| `research-orchestration` | Internal research and collaboration practices | adaptive research, panel roles, coverage and review contracts |
| `fleet-orchestration` | Internal benchmark collaboration practices | leader-only dispatch, shared workspace, runtime targeting, cleanup evidence |
